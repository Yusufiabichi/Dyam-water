...
const CharityPage = () => {
  ...
  const [copied, setCopied] = useState(false); // optional feedback

  const bankInfo = {
    bankName: 'Zenith Bank',
    accountName: 'DYAM Natural Water',
    accountNumber: '1234567890', // replace with real account number
  };
  ...
  const handlePlanSelect = (planId: string, planName: string, amount: number) => {
    ...
    setShowBankModal(true); // <-- open modal when clicking "Sponsor This Pack"
    setTimeout(() => {
